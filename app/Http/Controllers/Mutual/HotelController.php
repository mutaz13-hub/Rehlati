...
class HotelController extends Controller
{
    ...
    {
        $hotels = Hotel::with(['rooms.description', 'rooms.amenities', 'rooms.prices.season', 'location', 'city.location', 'description', 'amenities'])
    ...
    public function show(Hotel $hotel): JsonResponse
    {
        return $this->succeed(__('Hotel retrieved successfully'), new HotelResource(
            $hotel->load(['rooms.description', 'rooms.bedTypes', 'rooms.amenities', 'rooms.prices.season', 'location', 'city.location', 'description', 'amenities', 'myReview', 'topReviews.user'])
